...
const (
	TravelDestinationService_ListTravelDestnations_FullMethodName = "/travel_destination.TravelDestinationService/ListTravelDestnations"
	TravelDestinationService_GetTravelDestination_FullMethodName  = "/travel_destination.TravelDestinationService/GetTravelDestination"
	TravelDestinationService_GetTrendDestinations_FullMethodName  = "/travel_destination.TravelDestinationService/GetTrendDestinations"
)
...
func (c *travelDestinationServiceClient) ListTravelDestnations(ctx context.Context, in *ListDetinationRequest, opts ...grpc.CallOption) (*ListDetinationResponse, error) {
	...
	err := c.cc.Invoke(ctx, TravelDestinationService_ListTravelDestnations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *travelDestinationServiceClient) GetTravelDestination(ctx context.Context, in *GetDestinationRequest, opts ...grpc.CallOption) (*GetDestinationResponse, error) {
	...
	err := c.cc.Invoke(ctx, TravelDestinationService_GetTravelDestination_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *travelDestinationServiceClient) GetTrendDestinations(ctx context.Context, in *GetTrendDestinationRequest, opts ...grpc.CallOption) (*GetTrendDestinationResponse, error) {
	...
	err := c.cc.Invoke(ctx, TravelDestinationService_GetTrendDestinations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TravelDestinationService_ListTravelDestnations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TravelDestinationService_ListTravelDestnations_FullMethodName,
	}
...
func _TravelDestinationService_GetTravelDestination_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TravelDestinationService_GetTravelDestination_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TravelDestinationService_GetTrendDestinations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TravelDestinationService_GetTrendDestinations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
